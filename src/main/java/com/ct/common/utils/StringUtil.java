...
public class StringUtil {
	...
	public static String randomChineseString() {
		...
		int p;
		Random r = new Random();
		h=(176+Math.abs(r.nextInt(40)));
		r = new Random();
		p=161+Math.abs(r.nextInt(94));
		
		byte[] b = new byte[2];
		b[0] = (new Integer(h)).byteValue();
		b[1]= (new Integer(p)).byteValue();
		try {
			src = new String(b,"GB2312");
	...
	public static String generateChineseName(){
		...
		//首先拿姓
		String string = src[RandomUtil.random(0, src.length-1)];
		//名字获取
